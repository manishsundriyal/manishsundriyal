                        ...
                        return (
                            <Col xs={12} sm={6} md={6} lg={3} xl={3}>
                                <Card>
                                    ...
                                    <Card.Footer>
                                        <small className="text-muted"><FontAwesomeIcon icon={faCalendarAlt} className="mr-1" />{snippet.footer} <FontAwesomeIcon icon={faClock} className="mr-1 ml-2" />3 min read</small>
                                    </Card.Footer>
                                </Card>
                            </Col>
                        );
